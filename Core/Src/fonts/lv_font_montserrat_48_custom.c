 ...
 * Size: 48 px
 * Bpp: 1
 * Opts: --bpp 1 --size 48 --font Montserrat-Medium.ttf -r 0x30-0x39,0x20 --format lvgl -o out/lv_font_montserrat_48_custom.c
 ******************************************************************************/
...
#ifndef LV_FONT_MONTSERRAT_48_CUSTOM
    #define LV_FONT_MONTSERRAT_48_CUSTOM 1
#endif

#if LV_FONT_MONTSERRAT_48_CUSTOM
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1, .adv_w = 512, .box_w = 28, .box_h = 34, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 120, .adv_w = 284, .box_w = 13, .box_h = 34, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 176, .adv_w = 441, .box_w = 25, .box_h = 34, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 283, .adv_w = 439, .box_w = 26, .box_h = 34, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 394, .adv_w = 514, .box_w = 30, .box_h = 34, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 522, .adv_w = 441, .box_w = 25, .box_h = 34, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 629, .adv_w = 474, .box_w = 26, .box_h = 34, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 740, .adv_w = 459, .box_w = 26, .box_h = 34, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 851, .adv_w = 495, .box_w = 27, .box_h = 34, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 966, .adv_w = 474, .box_w = 26, .box_h = 34, .ofs_x = 1, .ofs_y = 0}
};
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t lv_font_montserrat_48_custom = {
#else
lv_font_t lv_font_montserrat_48_custom = {
#endif
...
#endif /*#if LV_FONT_MONTSERRAT_48_CUSTOM*/
