...
#define LV_MEM_CUSTOM 0
    ...
    #define LV_MEM_SIZE (24U * 1024U) // (48U * 1024U)          /*[bytes]*/

    /*Set an address for the memory pool instead of allocating it as a normal array. Can be in external SRAM too.*/
    #define LV_MEM_ADR 0 // 0x2001C000     /*0: unused*/
...
#define LV_MEM_BUF_MAX_NUM 16 // 16
...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(lv_font_montserrat_14_custom) LV_FONT_DECLARE(lv_font_montserrat_36_custom)
